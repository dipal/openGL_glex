...
project::project()
{
    sc = spaceCraft(point(0,0,0),angle(0,0,0));
    //s = spaceCraft(point(0,0,0),angle(0,0,0));
    //pos = point(200,0,50);
    pos = point(0,200,50);
    look = point(0,0,0);
    headDir = point(0,0,1);
...
void project::keyboardListener(unsigned char key, int x,int y) {
    //solarSystem.keyboardListener(key,x,y);
    sc.keyboardListener(key,x,y);
...
void project::mouseListener(int button, int state, int x, int y) {
    //solarSystem.mouseListener(button,state,x,y);
    sc.mouseListener(button,state,x,y);
