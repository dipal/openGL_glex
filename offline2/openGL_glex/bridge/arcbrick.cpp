...
void ArcBrick::draw() {
	//left
        Plane4Pt(point(-xLen, 0, zLen),point(-xLen, yLen, zLen),point(-xLen, yLen, 0),point(-xLen, 0, 0),
                          textureId, xRepeat,
			yRepeat).draw();

	//top
        Plane4Pt(point(0, 0, zLen),point(0, yLen, zLen),point(-xLen, yLen, zLen),point(-xLen, 0, zLen),
                          textureId, xRepeat,
			yRepeat).draw();
	...
	double step = M_PI_2 / numSteps;
		...
		//back triangle
                Plane4Pt(point(-xLen, yLen, zLen),point(x, yLen, z),point(x, yLen, z),point(prex, yLen, prez),
